...
const NO_TRADE_START =
  process.env.SUPERTREND_BCS_LIVE_NO_TRADE_START || '17:00';
const NO_TRADE_END = process.env.SUPERTREND_BCS_LIVE_NO_TRADE_END || '18:30';
const CLOSE_AT_NO_TRADE_START =
  String(
    process.env.SUPERTREND_BCS_LIVE_CLOSE_AT_NO_TRADE_START || 'true',
  ).toLowerCase() === 'true';
...
const LOG_SKIP_REASONS =
  String(process.env.SUPERTREND_BCS_LIVE_LOG_SKIP_REASONS || 'false').toLowerCase() ===
  'true';
...
async function setPositionAutoTopup(productId, enabled, contextLabel = '') {
  ...
  // Make the payload visible in logs (helps verify quickly in production)
  info(
    `AUTO_TOPUP request ${
